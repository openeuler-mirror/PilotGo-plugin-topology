<template>
  <!-- 外层抽屉组件 -->
  <el-drawer class="drawer" v-model="process_drawer" :with-header="false" direction="rtl" size="480px" :before-close="handleClose" :modal="true" :append-to-body="false">
...
let layout = reactive(layoutStore.process_layout_option);
